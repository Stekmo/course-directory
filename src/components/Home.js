...
class Home extends Component {
    ...
    handleSubmit = (e) => {
        ...
        // The history object contains information about previous pages. It's what let's you go back and forth between pages. Pushing the path to the object, redirects us to the page.
      ...
      <div className="main-content home">
        ...
        <hr />
          ...
          {TeacherList.map((teacher) => {
              return (
                  <Link to={`/teachers/${teacher.course}/${teacher.name}`}>{teacher.name}</Link>
              )
          })}
